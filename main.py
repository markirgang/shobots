...
class ESP32PulseWindow:
    ...
    def _run(self):
        ...
        self.root = tk.Tk()
        self.root.title("Shobots Controller")
        ...
        title_lbl = ttk.Label(header_frame, text="🤖 Shobots Controller", style="Header.TLabel")
...
def show_settings_dialog(pya_instance, default_mode="camera"):
    ...
    root = tk.Tk()
    root.title("Shobots Controller Setup & Settings")
